<x-guest-layout>
    <section class="w-full flex-grow">
        <section class="mx-auto my-6 grid w-full max-w-[1200px] grid-cols-1 gap-3 px-5 pb-10 lg:grid-cols-3 lg:pt-10">
            <div>
        ...
        <form class="mx-auto my-5 max-w-[600px] px-5 pb-10" action="/contact" method="POST" x-data="contactForm()">
            <div class="mx-auto">
            ...
            <div class="lg:items:center container mt-4 flex flex-col justify-between lg:flex-row">
                ...
                <button class="my-3 bg-amber-400 px-4 py-2 lg:my-0">Send Message</button>
            </div>
        </form>
