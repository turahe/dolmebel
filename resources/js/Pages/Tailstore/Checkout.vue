                    ...
                    <div class="lg:w-1/3">
                        <div class="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div class="space-y-4 mb-6">
                                <div v-for="item in orderItems" :key="item.id" class="flex items-center">
                            ...
                            <button 
                                ...
                                class="w-full bg-primary text-white py-3 px-6 rounded-lg font-semibold hover:bg-primary-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
...
const validateForm = () => {
    ...
    const requiredFields = [
        billing.firstName, billing.lastName, billing.email, billing.phone,
        billing.address, billing.city, billing.state, billing.zipCode, billing.country,
        shipping.firstName, shipping.lastName, shipping.address, shipping.city,
        shipping.state, shipping.zipCode, shipping.country,
        payment.cardNumber, payment.expiryDate, payment.cvv, payment.cardName
    ]
